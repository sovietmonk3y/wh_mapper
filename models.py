...
from wh_mapper.constants import NODE_ID_MAX_LENGTH, USERNAME_MAX_LENGTH, \
    ...
    SYSTEM_NODE_PAGE_NAME_MAX_LENGTH, SYSTEM_NODE_NOTES_MAX_LENGTH, \
    WORMHOLE_SIG_MAX_LENGTH, WORMHOLE_LIFE_MAX_LENGTH, \
    WORMHOLE_TOTAL_MASS_MAX_LENGTH, WORMHOLE_JUMP_MASS_MAX_LENGTH
