...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'SystemNode.system' to match new field type.
        db.rename_column(u'wh_mapper_systemnode', 'system_id', 'system_name')

    def backwards(self, orm):

        # Renaming column for 'SystemNode.system' to match new field type.
        db.rename_column(u'wh_mapper_systemnode', 'system_name', 'system_id')
