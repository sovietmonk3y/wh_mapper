...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute("INSERT INTO wh_mapper_wormhole (sig, type, life, total_mass, mass_regen, jump_mass, static) VALUES ('K162', 'c1', 16, 0, 0, 0, 0);")

    def backwards(self, orm):
        db.execute("DELETE FROM wh_mapper_wormhole WHERE sig = 'K162';")
